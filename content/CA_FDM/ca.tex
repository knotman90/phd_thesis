...
\centering
        \subfigure[Rule 250]{%
            ...
            \setlength{\fboxrule}{1pt}%
             \fbox{\includegraphics[scale=0.32]{./images/CA_FDM/rule250}}
        }%
        \subfigure[Rule 254]{%
           \label{fig:second}
           \setlength{\fboxrule}{1pt}
           \fbox{\includegraphics[scale=0.32]{./images/CA_FDM/rule254}}
        } %  ------- End of the first row ----------------------%
         \subfigure[Rule 4]{%
            \label{fig:first}
            \setlength{\fboxrule}{1pt}
             \fbox{\includegraphics[scale=0.32]{./images/CA_FDM/rule4}}
        }%
        \subfigure[Rule 108]{%
           \label{fig:second}
           \setlength{\fboxrule}{1pt}
           \fbox{ \includegraphics[scale=0.32]{./images/CA_FDM/rule108}}
        }\\ %  ------- End of the first row ----------------------%
...
\label{class34}
        \subfigure[Rule 30]{%
            \label{fig:first}
            \setlength{\fboxrule}{1pt}%
             \fbox{\includegraphics[scale=0.32]{./images/CA_FDM/rule30}}
        }%
        \subfigure[Rule 90]{%
           \label{fig:second}
           \setlength{\fboxrule}{1pt}
           \fbox{\includegraphics[scale=0.32]{./images/CA_FDM/rule90}}
        } %  ------- End of the first row ----------------------%
         \subfigure[Rule 54]{%
            \label{fig:first}
            \setlength{\fboxrule}{1pt}
             \fbox{\includegraphics[scale=0.32]{./images/CA_FDM/rule54}}
        }%
        \subfigure[Rule 110]{%
           \label{fig:second}
           \setlength{\fboxrule}{1pt}
           \fbox{ \includegraphics[scale=0.32]{./images/CA_FDM/rule110}}
        }\\ %  ------- End of the first row ----------------------%
...
\label{fig:glider}
\setlength{\fboxrule}{1pt}%
\fbox{\includegraphics[scale=0.9]{./images/CA_FDM/glider}}
\end{figure}
